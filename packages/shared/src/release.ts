 ...
 */
export const PRODUCT_VERSION = '0.2.0-test.1';
export const BUNDLE_VERSION = '0.2.0';
export const BUILD_NUMBER = '1';
export const RELEASE_CHANNEL = 'test';

export const AGENT_API_VERSION = 3;
export const MIN_SUPPORTED_AGENT_API_VERSION = 3;
export const MAX_SUPPORTED_AGENT_API_VERSION = 3;

export const BUILD_ID = `${PRODUCT_VERSION}+${BUILD_NUMBER}`;
export const RELEASE_TAG = `v${PRODUCT_VERSION}`;
export const RELEASE_ARTIFACT_NAME =
  `LocalVideoCompressor-v${PRODUCT_VERSION}-macOS-arm64.dmg`;
export const RELEASE_DOWNLOAD_URL =
  `https://github.com/Daynero/AffSupport/releases/download/${RELEASE_TAG}/${RELEASE_ARTIFACT_NAME}`;
