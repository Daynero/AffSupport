...
import { DEFAULT_FRAME_RATE, DEFAULT_RESOLUTION_LIMIT, clampCrf, clampFrameRate, clampResolutionLimit, clampVideoBitrateKbps, type AgentSettings, type CompressionJob } from '@video-compressor/shared';
export interface PersistedState { jobs: CompressionJob[]; settings: AgentSettings }
export const defaultSettings: AgentSettings = { preset: 'balanced', outputMode: 'next-to-originals', outputFolder: null, frameRate: DEFAULT_FRAME_RATE, videoBitrateKbps: null, keepResolution: true, resolutionLimit: DEFAULT_RESOLUTION_LIMIT };
