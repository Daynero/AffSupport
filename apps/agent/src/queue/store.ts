...
import { DEFAULT_FRAME_RATE, clampFrameRate, type AgentSettings, type CompressionJob } from '@video-compressor/shared';
export interface PersistedState { jobs: CompressionJob[]; settings: AgentSettings }
export const defaultSettings: AgentSettings = { preset: 'balanced', outputMode: 'next-to-originals', outputFolder: null, frameRate: DEFAULT_FRAME_RATE };
