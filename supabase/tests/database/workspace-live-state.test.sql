...
insert into public.team_catalog_events(team_id,event_kind) values
  ('a0260000-0000-4000-8000-000000000011','upserted'),
  ('a0260000-0000-4000-8000-000000000012','upserted');
