...
describe('saving and stopping', () => {
  ...
  it('refuses a viewer, an empty list, a foreign catalog, a strange interval and re-stitching without a computer', async () => {
    ...
    await expect(save([sheet], '1h', true)).rejects.toThrow(/AGENT_REQUIRED/);
  }, 60_000);
