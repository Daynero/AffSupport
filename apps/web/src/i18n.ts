...
const en = {
  ...
  gatekeeperHelp:
    'For an unnotarized test build, open Applications, Control-click Wishly Agent, choose Open, then confirm Open again. Do not disable Gatekeeper.',
...
const uk: Record<keyof typeof en, string> = {
  ...
  gatekeeperHelp:
    'Для ненотаризованої тестової версії відкрийте Applications, натисніть Control-click на Wishly Agent, виберіть Open і ще раз підтвердьте Open. Не вимикайте Gatekeeper.',
