...
| Catalog updater                 | Airtable field per row, Linear bulk edit | A row's value is edited in the row and saved at once; a selection edits many                              | Each catalog has its own "Every hour / day / week / N h / Off" picker and "Update now"; ticked rows get both for all of them; Start/Save/Stop and the one space-wide interval are gone                                                                 |
